...
namespace Mod03_WebApplications.ThumbsAndWatermarking {
    ...
    using System.Web; // adicionado using na primeira versao, ja adicionado na segunda versao
    ...
    /// </remarks>
    public class ThumbsAndWaterMarkHandler : IHttpHandler, IRequiresSessionState // adicionado IRequiresSessionState para obrigar a existir Session
    {
